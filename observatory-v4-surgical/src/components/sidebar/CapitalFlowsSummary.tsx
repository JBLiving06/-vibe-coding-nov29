    ...
    >
      ...
      <div className="px-4 py-3 border-b border-warm-100">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-semibold text-warm-800">Infrastructure</h3>
        </div>
        <p className="text-xs text-warm-500 mt-0.5">Shared systems enabling all priorities</p>
      </div>
          ...
          return (
            ...
            >
              ...
              <div className="flex items-baseline gap-2">
                <span className="text-lg font-semibold text-warm-800">{flow.currentQuarter}%</span>
